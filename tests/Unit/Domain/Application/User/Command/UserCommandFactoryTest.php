...
final class UserCommandFactoryTest extends AbstractUnitTestCase
{
    ...
    public function testInsert(): void
    {
        ...
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['namePrefix']);
        $actual   = $command->namePrefix;
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['nameFirst']);
        $actual   = $command->nameFirst;
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['nameMiddle']);
        $actual   = $command->nameMiddle;
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['nameLast']);
        $actual   = $command->nameLast;
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['nameSuffix']);
        ...
        $this->assertSame($expected, $actual);
        $expected = $filter->string($input['preferences']);
